			...
			<table style="border-spacing:2px 0px;border-collapse: collapse;">
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr style="border-top: 1px solid #000;">
						...
						<td style="border-right: 1px solid #000;"><strong>' . $row['firstname'] . '</strong></td>
						<td style="border-right: 1px solid #000;"><strong>' . $row['lastname'] . '</strong></td>
						<td style="border-right: 1px solid #000;">' . $row['email'] . '</td>
