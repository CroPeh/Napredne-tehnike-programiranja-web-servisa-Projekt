<?php 
	...
	if (isset($_GET['id']) && $_GET['id'] != '') {
		...
		<p><a href="index.php?menu='.$menu.'&amp;action='.$action.'" style="padding:3px;background-color:rgb(41, 90, 128);color:white;border-radius:25px;">Back</a></p>';
	}
	...
	#Edit news
		...
		print '
		<h2>News</h2>		
		<a href="index.php?menu=' . $menu . '&amp;action=' . $action . '&amp;add=true" class="AddLink" style="background-color:rgb(20, 22, 36);color:white;border-radius:25px;padding:5px;">Add news</a>
		<div id="news">
			<table style="border-spacing:2px 0px;border-collapse: collapse;">
				<thead>
					<tr>
						<th width="16"></th>
						<th width="16"></th>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr style="border-top: 1px solid #000;">
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;id=' .$row['id']. '" style="padding:3px;background-color:rgb(41, 90, 128);color:white;border-radius:25px;">INFO</a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"style="padding:3px;background-color:rgb(41, 90, 128);color:white;border-radius:25px;">EDIT</a></td>
						<td style="border-right: 1px solid #000;"><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"style="padding:3px;background-color:rgb(41, 90, 128);color:white;border-radius:25px;">DELETE</a></td>
						<td style="border-right: 1px solid #000;">' . $row['title'] . '</td>
						...
						<td style="border-right: 1px solid #000;">' . pickerDateToMysql($row['date']) . '</td>
						<td style="border-right: 1px solid #000;">';
							if ($row['archive'] == 'Y') { print '<p style="color:red;">Y</p>'; }
                            else if ($row['archive'] == 'N') { print '<p style="color:green;">N</p>'; }
						print '
						</td>
					</tr>';
				}
